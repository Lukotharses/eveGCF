...
language: "fr"
  ...
  jQuery(document).ready(function() {
    jQuery("#event_Manifestations_0_happens_at_jquery_control").datepicker(jQuery.extend({}, {
      ...
      showOn:     "button",
      onClose:    function(){ jQuery("#event_Manifestations_0_happens_at_day, #event_Manifestations_0_happens_at_month, #event_Manifestations_0_happens_at_year").change(); }
...
<tr>
  ...
  jQuery(document).ready(function() {
    ...
    .result(function(event, data) { jQuery(this).closest('form').find("#event_Manifestations_0_organism_id").val(data[1]).change(); });
  });
...
<tr>
  ...
  jQuery(document).ready(function() {
    jQuery("#event_Manifestations_1_happens_at_jquery_control").datepicker(jQuery.extend({}, {
      ...
      showOn:     "button",
      onClose:    function(){ jQuery("#event_Manifestations_1_happens_at_day, #event_Manifestations_1_happens_at_month, #event_Manifestations_1_happens_at_year").change(); }
...
<tr>
  ...
  jQuery(document).ready(function() {
    ...
    .result(function(event, data) { jQuery(this).closest('form').find("#event_Manifestations_1_organism_id").val(data[1]).change(); });
  });
...
<div id="editor">
        <div id="sf_admin_container" class="sf_admin_edit ui-widget ui-widget-content ui-corner-all">
        <div>
                            <canvas id="tktCanvas" style="width: 1000px; height: 400px; border: 1px solid #000000; margin: 0 auto;">
